...
In a second tab, find the URL associated with the Route to Gateway Service. You can find it using *OpenShift Web Console -> Project -> Routes* or the OpenShift CLI with the Web Terminal:
