...
Next, go to `Terminal` -> `Open Terminal in Specific Container` and select a container with name beginning with `vscode-`.
...
You should download locally the build results by right-clicking and saving the jar on your computer.
